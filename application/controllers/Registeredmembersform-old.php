...
class Registeredmembersform extends Requestcontrol {
	public function add_user(){
		...
		if($this->form_validation->run()){
			...
			send_sms($this->input->post('mobile'),"Hello ".$this->input->post('first_name').",%nYour society admin has created an account for you at www.societywizard.com%nYour login details are :%nusername : ".$this->input->post('mobile')."%npassword : ".$password);
