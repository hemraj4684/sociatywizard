...
<h5 class="breadcrumbs-title"><i class="fa fa-files-o"></i> Documents</h5>
<ol class="breadcrumb">
...
<div class="row mt10 height-600 break-word">
<div class="col s12">
<?=$this->session->flashdata('folder_removed')?>
<?php
if($folder->num_rows()===0){
	echo '<div class="card center"><div class="card-content"><span class="card-title">You dont have any folder</span><p class="mt15">To start uploading documents you should first create a folder.</p><p class="mt15">To create a new folder <a class="btn grey darken-3 btn-small modal-trigger" href="#folder_model"><i class="fa fa-plus left"></i> Click Here</a></p></div></div>';
}else{
echo '<div class="card"><div class="card-content"><div class="row">';
$folders = $folder->result();
foreach($folders as $key => $value) {
	echo '<div class="col s6 m4 l3"><a class="r-able folder-link" data-id="'.$value->id.'" data-name="'.h($value->folder_name).'" data-desc="'.h($value->description).'" href="'.base_url('documents/folder/'.$value->id).'"><h1 class="mb0"><i class="folder-icon fa fa-folder-open"></i></h1><p class="black-text bold-500">'.h($value->folder_name).'</p></a></div>';
}
unset($value);
...
<div class="modal-content">
  ...
  <div class="input-field">
	<input name="folder" type="text" maxlength="50" autocomplete="off" placeholder="Folder Name">
  </div>
  <div class="input-field">
...
<div class="modal-footer">
	<div class="input-field"><div class="col s12"><div class="res"></div></div></div>
	<button type="submit" class="waves-effect folder-c-btn btn-flat">Create</button>
...
<div class="modal-content">
  ...
  <h5 class="mt0 bold-500 mb15">Update Folder Properties</h5>
  	<div class="input-field col s12">
		...
		<input name="folder" type="text" id="folder_name" maxlength="50" placeholder="Folder Name" autocomplete="off">
		<input name="old_folder" type="hidden" id="folder_name_old" maxlength="50" placeholder="Folder Name" autocomplete="off">
    </div>
	<div class="input-field col s12">
